<?php
 //This file is main body of the Warm Mail application
 //It works basically as a state machine and shows users the
 //output for the action they have closen
 //***********************************************************************
 ...
 //need to prcess log in or out requests before header has output
 if($username || $passwd){
 ...
 //*************************************************************************************
  //display any text generated by function main body content
  echo $status;
  ...
  if(!check_auth_user()){
  	...
  	switch ($action){
  		//if we have choose to setup a new account, or have just added or
  		...
  		case 'delete':
  			delete_message($_SESSION['auth_user'],$_SESSION['selected_account'],$messagid);
  		...
  		case 'view-message':
  			...
  			display_message($_SESSION['auth_user'], $_SESSION['selected_account'],$messagid,$fullheaders);
  		break;
  		...
  		case 'reply-all':
  			...
  			if($imap){
  				$header = imap_header($imap, $messagid);
  				if($header->reply_toaddress){
  					$to = $header->reply_toaddress;
  				}else{
  					$to = $header->reply_fromaddress;
  				}
  				
  				$cc = $header->ccaddress;
  				$subject = "Re: ".$header->subject;
  				$body = add_quoting(stripslashes(imap_body($imap,$messagid)));
  				imap_close($imap);
